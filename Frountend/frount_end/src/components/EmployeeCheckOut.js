...
export default function EmployeeCheckOut() {
    ...
    const handleCheckOut = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8070/attendance/checkout', {
            ...
            if (err.response) {
                ...
                setError('Error occurred during check-out. Please try again.');
            }
        }
    };
    ...
    return (
        <div style={styles.container}>
            <h2 style={styles.header}>Employee Check-Out</h2>
